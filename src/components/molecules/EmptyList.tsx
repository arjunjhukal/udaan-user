    ...
    return (
        <Box className="flex items-center justify-center p-13">
            <Box className="flex flex-col items-center">
                ...
                <Typography variant="h4" fontWeight={600} color="brand.main" mt={1}>{title}</Typography>
                <Typography variant="subtitle1" fontWeight={400} color="text.middle" mt={"2px"}>{description}</Typography>
