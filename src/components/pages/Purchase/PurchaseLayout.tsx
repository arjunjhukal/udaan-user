...
// import { useGetCourseByIdQuery, usePurchaseCourseMutation } from "../../../services/courseApi";
...
//                 });
//                 const gateway = response?.data?.data?.payment_gateway;
//                 const endpoint = response?.data?.data?.endpoint;
//                 const params = response?.data?.data?.params;

//                 if (gateway === "esewa") {
//                     submitEsewaForm(endpoint, params);
//                 }

//                 dispatch(showToast({
//                     message: response?.data?.message || "Unable to proceed for payment. Try Again Later.",
//                     severity: "success"
//                 }))
//             }
//             catch (e: any) {
