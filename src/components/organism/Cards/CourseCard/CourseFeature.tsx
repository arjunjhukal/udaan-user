                ...
                <div className="feature flex gap-2 items-center">
                    ...
                    <div className="feature-content items-center flex gap-1.5">
                        ...
                        {endAt ? <>
                            ...
                            <div className="end">
                                <Typography variant="caption" color="primary">{t("messages.ends")}</Typography>
                                <Typography variant="caption" fontWeight={500} className="block">
