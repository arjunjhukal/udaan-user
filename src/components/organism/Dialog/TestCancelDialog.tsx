            ...
            <DialogContent>
                <div className="flex gap-8 flex-col">
                    ...
                    <div className="content flex flex-col gap-2">
                        <Typography variant='text4Xl' fontWeight={600}>Are You Sure You Want to Leave This Quiz?</Typography>
                        <Typography variant='textBase' color='text.middle' >Your submitted answers will be evaluated, while unanswered questions will not be considered for marking.</Typography>
                    </div>
